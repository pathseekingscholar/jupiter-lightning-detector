param(
    [ValidateSet("init", "download", "analyze", "report", "all", "test", "app", "detect", "detect-all", "exports", "coverage", "coverage-summary", "review", "geometry", "geometry-plan", "filters", "label-audit", "review-plan", "label-protocol", "training-readiness", "claim-audit", "research-gates", "issue-backlog", "agreement-audit", "label-template", "label-import", "label-summary", "provenance", "validate-outputs")]
    [string]$Command = "all",
